...
export const COPY = {
  en: {
    ...
    heroTitle: "Website.",
    heroTitleRest: "Real. Found.",
    heroBody:
      "We rebuild your website, or we build the one you do not have yet. For businesses in Montreal and the West Island.",
    heroNote: "It starts with a short note about the business.",
    orbitHoursK: "Hours",
    orbitHoursV: "Mon to Sat",
    orbitBookK: "Book",
    orbitBookV: "Your tool stays",
    orbitSearchK: "Search",
    orbitSearchV: "Montreal near me",
    orbitLangK: "Language",
    orbitLangV: "EN  |  FR",
    orbitMenuK: "Prices",
    orbitMenuV: "As printed",
    orbitCityK: "West Island",
    orbitCityV: "Pointe-Claire",
    orbitPhoneK: "Call",
    orbitPhoneV: "On the site",
    goalTitle: "Whatever the business needs, we build the site for it",
    goal1Title: "Put the business online",
    goal1Body: "A first site, or a rebuild. Hours, prices, and how people book.",
    goal2Title: "Get found in Montreal",
    goal2Body:
      "The site is built so people in Montreal and the West Island can find you.",
    goal3Title: "Keep the booking you have",
    goal3Body:
      "Booksy, Setmore, Square, OpenTable. We do not replace that door.",
    svcTitle: "What we make",
    svcLead: "A website that looks like the business, then people can find it.",
    svc1Title: "Websites",
    svc1Body:
      "Home, hours, prices, team, and contact. Built to hold on a phone.",
    svc2Title: "Rebuilds",
    svc2Body:
      "Keep the facts. Keep the booking tool. Change the site people land on.",
    svc3Title: "English and French",
    svc3Body: "English first. French when the business already uses it.",
    svc4Title: "Care",
    svc4Body: "Hosting, watch, and small edits after it goes live. $175 a month.",
    svcCta: "See the numbers",
    marquee:
      "Montreal  ·  West Island  ·  Pointe-Claire  ·  Dollard-Des-Ormeaux  ·  Ile-Perrot  ·  Laval  ·  ",
  ...
  fr: {
    ...
    heroNote: "Ça commence par une courte note sur l'entreprise.",
    orbitHoursK: "Heures",
    orbitHoursV: "Lun au sam",
    orbitBookK: "Réserver",
    orbitBookV: "Votre outil reste",
    orbitSearchK: "Recherche",
    orbitSearchV: "Montréal près de moi",
    orbitLangK: "Langue",
    orbitLangV: "EN  |  FR",
    orbitMenuK: "Prix",
    orbitMenuV: "Comme imprimé",
    orbitCityK: "Ouest-de-l'Île",
    orbitCityV: "Pointe-Claire",
    orbitPhoneK: "Appel",
    orbitPhoneV: "Sur le site",
    goalTitle: "Quel que soit le besoin, on construit le site pour ça",
    goal1Title: "Mettre l'entreprise en ligne",
    goal1Body:
      "Un premier site, ou une refonte. Heures, prix, et comment on réserve.",
    goal2Title: "Être trouvé à Montréal",
    goal2Body:
      "Le site est fait pour que les gens de Montréal et de l'Ouest-de-l'Île vous trouvent.",
    goal3Title: "Garder vos réservations",
    goal3Body:
      "Booksy, Setmore, Square, OpenTable. On ne remplace pas cette porte.",
    svcTitle: "Ce que nous faisons",
    svcLead: "Un site qui ressemble à l'entreprise, puis les gens peuvent le trouver.",
    svc1Title: "Sites",
    svc1Body:
      "Accueil, heures, prix, équipe, et contact. Conçu pour tenir sur un téléphone.",
    svc2Title: "Refontes",
    svc2Body:
      "Garder les faits. Garder l'outil de réservation. Changer le site où les gens arrivent.",
    svc3Title: "Anglais et français",
    svc3Body: "Anglais d'abord. Français quand l'entreprise l'utilise déjà.",
    svc4Title: "Entretien",
    svc4Body:
      "Hébergement, surveillance, et petits changements après le lancement. 175 $ par mois.",
    svcCta: "Voir les tarifs",
    marquee:
      "Montréal  ·  Ouest-de-l'Île  ·  Pointe-Claire  ·  Dollard-Des-Ormeaux  ·  Île-Perrot  ·  Laval  ·  ",
