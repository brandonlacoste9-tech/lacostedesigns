...
export const WORK: WorkItem[] = [
  ...
  },
  {
    ...
    city: "Montréal",
    cityFr: "Montréal",
    note: "A consultation still takes the project.",
    noteFr: "Une consultation prend encore le projet.",
    booking: "Consultation",
    preview: "https://vkgroup.grok.me",
    image: "/assets/work/vk-group.jpg",
    featured: true,
    body: "Luxury renovation and high-end construction in Montréal. Design and build, preconstruction through handover. English and French. A consultation still takes the project.",
    bodyFr:
      "Rénovation de luxe et construction haut de gamme à Montréal. Conception et chantier, de la préconstruction à la remise. Français et anglais. Une consultation prend encore le projet.",
  },
  {
    slug: "metric-homes",
    kind: "builder",
    ...
    city: "Ottawa",
    cityFr: "Ottawa",
    note: "A principal still reads the enquiry.",
    noteFr: "Un associé lit encore la demande.",
    booking: "Enquire",
    preview: "https://metrichomes.grok.me",
    image: "/assets/work/metric-homes.jpg",
    featured: true,
    body: "Custom houses in Ottawa. Arbourbrook, Trail View, Fox Run. About twenty-five a year. A principal still reads the enquiry.",
    bodyFr:
      "Maisons sur mesure à Ottawa. Arbourbrook, Trail View, Fox Run. Environ vingt-cinq par année. Un associé lit encore la demande.",
  },
  {
    slug: "b-barbier",
    kind: "shop",
